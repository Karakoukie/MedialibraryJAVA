...
public class AddMovieController {
    ...
    public static ArrayList<PersonEntity> getPersonFields() {
        ...
        try {
            ...
            if (statement != null) {
                while (statement.next()) {
                    int id = statement.getInt("id_personnne");
                    String name = statement.getString("nom");
                    String firstName = statement.getString("prenom");

                    personList.add(new PersonEntity(id, name));
                }
            }
        }
        catch (Exception ex) {
    ...
    public static void addMovie(String title, float price, String stateName, int year,
